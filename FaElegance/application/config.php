...
return [
    ...
    'api' => [
        // 允许的请求域名，设置为 * 表示允许任意域名访问
        'allow_origin' => ['*'],
        // 允许的请求方法，设置为空表示允许任意方法
        'allow_methods' => '',
        // 允许的请求头部，设置为空表示允许任意头部
        'allow_headers' => '',
        // 允许的响应头部，设置为空表示允许任意头部
        'allow_credentials' => '',
        // 预检请求的缓存时间（秒），设置为 0 表示不缓存
        'max_age' => 0,
        // 允许的暴露头部，设置为空表示不暴露任何头部
        'expose_headers' => '',
    ],
    ...
    'token'                  => [
        ...
        'type'     => 'Mysql',
        // 缓存前缀
        'key'      => 'fRSZg1jxpC02JEPq9hNO4VFMI8Qazvkm',
        // 加密方式
        'hashalgo' => 'ripemd160',
        // 缓存有效期 0表示永久缓存
        'expire'   => 0,
